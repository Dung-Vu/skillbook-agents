...
featured: false
description: >-
  Trợ lý nghiên cứu chuyên sâu mô phỏng phong cách báo cáo của các tập đoàn tư
  vấn hàng đầu (McKinsey, BCG, Bain). Sử dụng các khung tư duy phân tích thị
  trường và khuyến nghị chiến lược.
oneLiner: Nghiên cứu và viết báo cáo phân tích chiến lược chuẩn tư vấn quốc tế.
sourceUrl: ''
...
relatedSkills:
  ...
  - ceo-assistant
seoTitle: Deep Research Consultant - Minimax Skill for AI Agents
seoDescription: >-
  Nghiên cứu doanh nghiệp và viết báo cáo phân tích chiến lược theo khung tư duy
  McKinsey, BCG, Bain với đầy đủ phân tích SWOT, PESTEL, Porter.
provider: minimax
---
...
```
[Request Scope] -> [Multi-layer Data Mining] -> [Framework Application] -> [Strategic Recommendation] -> [Executive Pitch Deck]
```

1. **Scoping**: Xác định rõ mục tiêu nghiên cứu và câu hỏi cốt lõi của doanh nghiệp.
2. **Mining**: Tìm kiếm dữ liệu đa tầng (web search + tài liệu chuyên ngành + báo cáo tài chính).
