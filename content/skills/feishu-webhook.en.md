...
description: "Feishu/Lark Webhook messaging assistant. Send messages to Feishu groups via Webhook: plain text, rich text (Post), interactive cards with complex layouts, buttons, charts, tables, and images."
...
seoDescription: "Integrate Feishu/Lark Webhooks to automate reports, notifications, and rich interactive message cards with buttons."
---
