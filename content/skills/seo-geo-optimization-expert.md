...
featured: false
description: >-
  Chuyên gia tối ưu hóa công cụ tìm kiếm truyền thống (SEO) và tối ưu hóa cho
  công cụ tìm kiếm AI thế hệ mới (GEO). Giúp nội dung dễ dàng được trích dẫn bởi
  ChatGPT, Gemini, Perplexity.
oneLiner: >-
  Tối ưu hóa nội dung website để hiển thị trên Google và các công cụ tìm kiếm AI
  (GEO).
sourceUrl: ''
sourceAuthor: Minimax
lastVerified: '2026-06-03'
relatedSkills: []
seoTitle: SEO & GEO Optimization Expert - Minimax Skill for AI Agents
seoDescription: >-
  Cách tích hợp kỹ năng SEO & GEO cho AI Agent để nâng cao tỷ lệ trích dẫn nội
  dung từ các mô hình ngôn ngữ lớn (LLMs).
provider: minimax
---
...
```
Phan tich Noi dung hien tai --> Danh gia chi so GEO --> Toi uu hoa Cau truc & EEAT --> Xuat tai lieu huong dan
```
1. **Kiểm toán nội dung**: Đọc nội dung bài viết, phân tích từ khóa chính và cấu trúc thẻ tiêu đề.
2. **Đánh giá GEO**: Phân tích khả năng trích dẫn dựa trên các yếu tố: Mật độ nguồn dẫn (Citations), Độ trích dẫn thống kê (Statistical density), Sự rõ ràng của định nghĩa.
