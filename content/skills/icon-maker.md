...
featured: false
description: >-
  Trình tạo biểu tượng (icon) chuyên nghiệp sử dụng AI. Hỗ trợ thiết kế icon ứng
  dụng, favicon trang web, logo thương hiệu với hơn 20 phong cách nghệ thuật
  khác nhau.
oneLiner: Thiết kế biểu tượng và logo chuyên nghiệp từ mô tả văn bản.
sourceUrl: ''
...
seoDescription: >-
  Trình tạo icon ứng dụng chuyên nghiệp sử dụng AI: thiết kế biểu tượng 3D, tối
  giản, vintage chất lượng cao.
provider: minimax
---
...
1. **Style Selection**: Sử dụng giao diện Wizard để người dùng chọn phong cách thiết kế.
